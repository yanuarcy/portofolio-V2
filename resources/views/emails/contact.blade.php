    ...
    <div class="container">
        <div class="content">
            ...
            <div class="time-stamp">
                📅 Diterima pada {{ now()->format('d F Y') }} pukul {{ now()->format('H:i') }} WIB
            </div>

            <div class="action-section">
                <a href="mailto:{{ $contactData['email'] }}?subject=Re: Pesan dari Website&body=Halo {{ $contactData['fullname'] }}, %0D%0A%0D%0ATerima kasih atas pesan Anda." class="reply-btn">
                    Balas Pesan
                </a>
            </div>
        </div>
